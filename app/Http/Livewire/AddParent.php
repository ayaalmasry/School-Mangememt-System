...
class AddParent extends Component
{
    ...
    public $catchError='';
     public $photos,$show_table=true,$updateMode=false,$Parent_id;
    ...
    public function firstStepSubmit(){
        ...
        $validate=$this->validate([
          // 'Email' => 'required'.$this->id,
           ...
           // 'National_ID_Father' => 'required' . $this->id,
            //'Passport_ID_Father' => 'required' . $this->id,
             ...
             if (!empty($this->photos)){
                foreach ($this->photos as $photo) {
                    ...
                    ParentAttachment::create([
                        ...
                        'parent_id' => My_Parent12::latest()->first()->id,
                    ]);
                }
            }
     ...
     public function edit($id)
    {
        ...
        $My_Parent = My_Parent12::where('id',$id)->first();
        $this->Parent_id = $id;
   ...
   public function submitForm_edit(){
        ...
        if ($this->Parent_id){
            $parent =  My_Parent12::find($this->Parent_id);
            $parent->update([
    ...
    public function delete($id){
        My_Parent12::findOrFail($id)->delete();
        return redirect()->to('/add_parent');
    }
