...
@section('css')
    @toastr_css
@section('title')
    {{trans('main.Bills of exchange')}}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
@section('PageTitle')
   {{trans('main.Bills of exchange')}} {{$student->name}}
@stop
<!-- breadcrumb -->
@endsection
@section('content')
                ...
                <div class="card-body">
                    ...
                    <form method="post"  action="{{ route('Payment_students.store') }}" autocomplete="off">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>{{trans('Receipt.Student credit')}}: </label>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>ا{{trans('Receipt.Statement')}}: <span class="text-danger">*</span></label>
