    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title" id="exampleModalLabel">{{trans('Receipt.Delete Bills of exchange')}}</h5>
            ...
            <div class="modal-body">
                <form action="{{route('Payment_students.destroy','test')}}" method="post">
                    ...
                    <h5 style="font-family: 'Cairo', sans-serif;">{{trans('Receipt.Delete')}}</h5>
