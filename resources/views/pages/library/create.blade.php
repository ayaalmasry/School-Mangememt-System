...
@section('css')
    @toastr_css
@section('title')
    {{trans('library.Add New Book')}}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
@section('PageTitle')
   {{trans('library.Add New Book')}}@stop
<!-- breadcrumb -->
@endsection
@section('content')
    <!-- row -->
                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12">
                            ...
                            <form action="{{route('library.store')}}" method="post" enctype="multipart/form-data">
                                ...
                                <button class="btn btn-success btn-sm nextBtn btn-lg pull-right" type="submit">{{trans('library.Save')}}</button>
                            </form>
                        </div>
                    </div>
                </div>
