                ...
                <div class="col-lg-4">
                    <div class="card mb-4">
                        <div class="card-body text-center">
                            ...
                            <p class="text-muted mb-4">{{trans('main.Teacher')}}</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-8">
                    <div class="card mb-4">
                        <div class="card-body">
                            <form action="{{route('profile.update',$information->id)}}" method="post">
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <p class="mb-0">{{trans('main.user name ar')}}</p>
                                    </div>
                                    <div class="col-sm-9">
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <p class="mb-0">{{trans('main.user name en')}}</p>
                                    </div>
                                    <div class="col-sm-9">
                                        <p class="text-muted mb-0">
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <p class="mb-0"> {{trans('main.password')}}</p>
                                    </div>
                                    <div class="col-sm-9">
                                        <p class="text-muted mb-0">
                                        ...
                                        <input type="checkbox" class="form-check-input" onclick="myFunction()"
                                               id="exampleCheck1">
                                        <label class="form-check-label" for="exampleCheck1">{{trans('main.apperpasw')}}</label>
                                    </div>
                                </div>
                                <hr>
