...
@section('css')
    @toastr_css
@section('title')
    {{trans('Questions.Add New Question')}}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12">
                            <br>
                            <form action="{{ route('ques.store') }}" method="post" autocomplete="off">
                                @csrf
                                <div class="form-row">
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        <label for="title">{{trans('Questions.Answer')}}    <span style="color:red;font-size:smaller">{{trans('Questions.sper')}}</span></label>
