...
@section('css')
    @toastr_css
@section('title')
    {{trans('Receipt.Edit study fee processing')}}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
@section('PageTitle')
     {{trans('Receipt.Edit study fee processing')}}   : <label style="color: red">{{$ProcessingFee->student->name}}</label>
@stop
<!-- breadcrumb -->
@endsection
@section('content')
                ...
                <div class="card-body">
                    ...
                    @endif
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>{{trans('Receipt.Statement')}} : <span class="text-danger">*</span></label>
