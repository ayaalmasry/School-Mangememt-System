...
@section('css')
    @toastr_css
@section('title')
    {{ trans('Sections_trans.title_page') }}: {{trans('main.Attendance')}}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
                                                            ...
                                                            <table class="table center-aligned-table mb-0">
                                                                ...
                                                                @foreach ($Grade->Sections as $list_Sections)
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <a href="{{route('Attendance.show',$list_Sections->id)}}" class="btn btn-warning btn-sm" role="button" aria-pressed="true">{{trans('main.list_students')}}</a>
                                                                        </td>
                                                                    </tr>
                                                                @endforeach
                                                                </tbody>
