                                            ...
                                            <td>{{$student->section->Name_Section}}</td>
                                                <td>
                                                  <!--  <a href="{{route('Student.edit',$student->id)}}" class="btn btn-info btn-sm" role="button" aria-pressed="true"><i class="fa fa-edit"></i></a>
                                                    ...
                                                    <a href="{{route('Student.show',$student->id)}}" class="btn btn-warning btn-sm" role="button" aria-pressed="true"><i class="far fa-eye"></i></a>
                                                      <a href=" {{route('Fees_Invoices.show',$student->id)}}" class="btn btn-success btn-sm" role="button" aria-pressed="true"><i class="far fa-edit"></i></a>
                                                    <a  href="{{route('receipt_students.show',$student->id)}}" class="btn btn-sm"><i style="color: #9dc8e2" class="fas fa-money-bill-alt"></i></a>
                                                     <a  href="{{route('ProcessingFee.show',$student->id)}}" class="btn btn-sm"><i style="color: #9dc8e2" class="fas fa-money-bill-alt"></i></a>-->
