            ...
            <div class="col-md-12 mb-30">
                <div class="card card-statistics h-100">
                    <div class="card-body">
                        ...
                        <form method="post"  action="{{ route('sons.attendanceschild.search') }}" autocomplete="off">
                            @csrf
                            <h6 style="font-family: 'Cairo', sans-serif;color: blue">{{trans('main.info search')}}</h6><br>
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="student">{{trans('main.students')}}</label>
                                ...
                                <div class="card-body datepicker-form">
                                    <div class="input-group" data-date-format="yyyy-mm-dd">
                                        ...
                                        <span class="input-group-addon"> {{trans('main.ToDate')}}</span>
                            ...
                            <div class="table-responsive">
                                <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50"
                                    ...
                                    <tr>
                                        ...
                                        <th class="alert-success">{{trans('main.Date')}}</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if($student->attendence_status == 0)
                                                    <span class="btn-danger">{{trans('Students_trans.absent')}}</span>
                                                @else
