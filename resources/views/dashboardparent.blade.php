 ...
 Main content -->
        ...
        <div class="content-wrapper">
            <div class="page-title" >
                <div class="row">
                    <div class="col-sm-6" >
                        <h4 class="mb-0" style="font-family: 'Cairo', sans-serif"> {{trans('main.welcome')}} : {{auth()->user()->Name_Father}}</h4>
                    </div><br><br>
                    <div class="col-sm-6">
                                    ...
                                    <div class="card text-black">
                                        ...
                                        <div class="card-body">
                                            <div class="text-center">
                                                ...
                                                <p class="text-muted mb-4">{{trans('main.info stu')}}</p>
                                            </div>
                                            <div>
                                                <div class="d-flex justify-content-between">
                                                    <span>{{trans('main.grade')}}</span><span>{{$son->grade->Name}}</span>
                                                </div>
                                                <div class="d-flex justify-content-between">
                                                    <span>{{trans('main.class')}}</span><span>{{$son->classroom->Name_Class}}</span>
                                                </div>
                                                <div class="d-flex justify-content-between">
                                                    <span>{{trans('main.sec')}}</span><span>{{$son->section->Name_Section}}</span>
                                                </div>
